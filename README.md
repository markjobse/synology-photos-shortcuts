...
The extension now also remembers the last selected destination in the copy / move dialog and tries to reselect it automatically the next time you open either dialog.
